...
interface ListItemProps extends Omit<ComponentProps<'li'>, 'ref'> {
  text: string
}
...
const ListItem = forwardRef<HTMLLIElement, ListItemProps>((props, ref) => {
  ...
  return (
    <li className={tailwindClassMerger('text-body-color dark:text-dark-6 flex text-base', className)} {...other} ref={ref}>
        ...
        <svg width={20} height={20} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_980_24852)">
            <path
              ...
              className="fill-secondaryColor md:fill-primaryColor"
            />
            <path
      ...
      <span className="font-primaryFont text-lg capitalize text-[#181818]">{text}</span>
    </li>
  )
})
